...
const CarScrollPath = ({ scrollContainerRef, isVisible = false, onScrollStart, onComplete }) => {
    // --- CONFIG ---
    const START_X = 62.5; // Aligns with Arrow End (50% + 12.5%)
    const START_Y = 175;  // Reverted to original Y position
    const END_X = 35;
    const END_Y = 225;
    const pathD = `M ${START_X},${START_Y} C ${START_X + 2},${START_Y + 25} ${END_X - 10},${END_Y - 25} ${END_X},${END_Y}`;
    ...
    return (
        <div className="car-scroll-wrapper" style={{
            ...
            <UniversalScrollPath
                ...
                scaleX={-0.012}           // Squished + Flipped
                scaleY={0.025}            // Scaled Down
            ...
            >
                ...
                <g transform="translate(-128, -128)">
                    <g transform="scale(2.81) translate(1.4, 1.4)">
                        <circle cx="70.7" cy="56.8" r="2" fill="black" />
                        <circle cx="19.8" cy="56.8" r="2" fill="black" />
